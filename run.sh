...
python3 run_representation.py --exp_name case-control/nP=9k/puNCE-pi=oracle --dataset imagenet
# python3 run_representation.py --exp_name case-control/nP=4k/ssCL --dataset imagenet
