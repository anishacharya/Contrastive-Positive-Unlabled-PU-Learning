...
CKPT="logs/checkpoints/imagenet/single-dataset/gamma=0.5/pCL/0/epoch=99.ckpt"
python3 run_tsne.py --checkpoint $CKPT --dataset imagenet --fig_name tsne_plots/imagenet-nP=5k-puCL
