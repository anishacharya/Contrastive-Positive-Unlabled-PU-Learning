...
CKPT="logs/checkpoints/cifar10.hard/sup-sCL/0/epoch=299.ckpt"
python3 run_tsne.py --checkpoint $CKPT --dataset cifar10.hard --fig_name tsne_plots/cifar10-hard-nP=5k
